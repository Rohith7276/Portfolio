...
const ExperienceCard = ({
  ...
  <div className="group relative overflow-hidden transform hover:-translate-y-2 md:w-[40vw] transition-all duration-300">
...
const ExperienceSection = () => {
  const experiences = [
 ...
 
    {
      ...
      period: "2024",
      description:
        "Led a team of developers to secure 2nd rank in the track and 3rd place among club developers by creating innovative and creative websites. Mentored junior members, fostering a collaborative environment and ensuring timely project delivery.",
    },
  ];
    ...
    <>
      <div className="min-h-screen bg-gradient-to-b relative overflow-hidden pt-32 pb-20">
        ...
        <div className="relative container mx-auto px-6 mt-10">
          ...
          <div className="flex md:flex-row flex-col gap-14 md:gap-24 mx-11">
